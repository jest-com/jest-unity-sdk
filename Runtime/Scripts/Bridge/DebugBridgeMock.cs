...
namespace com.jest.sdk
{
    ...
    public class DebugBridgeMock : IBridgeMock
    {
        ...
        public string GetPurchaseResponse()
        {
            ...
            return "{\"result\":\"success\",\"purchase\":{\"purchaseToken\":\"mock_token_debug\",\"productSku\":\"gems_100\",\"credits\":99,\"createdAt\":1761729039,\"completedAt\":null,\"estimatedRevenue\":85.8,\"price\":99.0,\"currency\":\"USD\"},\"purchaseSigned\":\"JWS\"}";
        }
        ...
        /// </summary>
        /// <returns>A JSON string containing mock subscriptions and signed payload.</returns>

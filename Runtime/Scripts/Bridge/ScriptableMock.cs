...
namespace com.jest.sdk
{
    ...
    public class ScriptableMock : ScriptableObject, IBridgeMock
    {
        ...
        public string GetPurchaseResponse()
        {
            switch (_purchaseResult)
            {
                case PurchaseReult.success:
                    return "{\"result\":\"success\",\"purchase\":{\"purchaseToken\":\"mock_token_bcwux13xvm4\",\"productSku\":\"gems_100\",\"credits\":99,\"createdAt\":1761729039,\"completedAt\":null,\"estimatedRevenue\":85.8,\"price\":99.0,\"currency\":\"USD\"},\"purchaseSigned\":\"JWS\"}";
                default:
        ...
        {
            return "{\"referrals\":[{\"reference\":\"mock-ref\",\"registrations\":[{\"playerId\":\"user1\",\"joinedAt\":\"2026-01-01T00:00:00Z\"}]}],\"referralsSigned\":\"mock_signed\"}";
        }
        ...
        {
            return "{\"subscriptions\":[{\"sku\":\"premium\",\"displayName\":\"Premium Subscription\",\"displayDescription\":\"Unlock premium features and exclusive content.\",\"price\":9.99,\"currency\":\"USD\",\"billingPeriod\":\"monthly\",\"status\":\"inactive\",\"trialEligible\":true}],\"signed\":\"\"}";
        }

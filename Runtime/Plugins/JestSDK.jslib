mergeInto(LibraryManager.library, {
  $JestSDKHelper: {
      ...
      JestSDKHelper.sdkLoadPromise = new Promise(function (resolve, reject) {
        ...
        script.onload = function () {
          if (window.JestSDK) {
            ...
            reject(
              new Error(
                "Loaded jestsdk.js, but window.JestSDK was not defined",
              ),
            );
          }
        };
    ...
    getSdk: function () {
      if (!window.JestSDK) {
        throw new Error(
          "JestSDK is not initialized. Call JestSDK.Instance.Init() first.",
        );
      }
      ...
      try {
        JestSDKHelper.asPromise(fn())
          ...
          .catch(function (err) {
            ...
            (taskPtr,
              JestSDKHelper.marshalString(JestSDKHelper.toErrorMessage(err)));
          });
      } catch (err) {
        {
          {
      ...
      try {
        JestSDKHelper.asPromise(fn())
          .then(function (result) {
            ...
            (taskPtr, JestSDKHelper.marshalString(result));
          })
          .catch(function (err) {
            {
              {
  ...
  JS_getPlayerData: function () {
    ...
    return JestSDKHelper.marshalString(
      JSON.stringify(
  ...
  JS_getIsRegistered: function () {
    var player = JestSDKHelper.getSdk().getPlayer();
    return JestSDKHelper.marshalString(
      player && player.registered ? "true" : "false",
    );
  },
  ...
  JS_getPlayerAvatar: function (size) {
    var profile = JestSDKHelper.getSdk().social.getProfile({
      avatarSize: size,
    });
  ...
  JS_scheduleNotificationV2: function (
    taskPtr,
    options,
    successCallback,
    errorCallback,
  ...
  JS_unscheduleNotificationV2: function (
    taskPtr,
    identifier,
    successCallback,
    errorCallback,
  ...
  JS_getIncompletePurchases: function (
    taskPtr,
    successCallback,
    errorCallback,
  ) {
    JestSDKHelper.callStringTask(
      ...
      function () {
        return JestSDKHelper.getSdk()
          .payments.getIncompletePurchases()
          .then(function (result) {
            return JSON.stringify(result);
          });
      },
  ...
  JS_cancelSubscription: function (
    taskPtr,
    subscriptionSku,
    successCallback,
    errorCallback,
  ...
  JS_openReferralDialog: function (
    taskPtr,
    optionsJson,
    successCallback,
    errorCallback,
    ...
    JestSDKHelper.callVoidTask(
      ...
      errorCallback,
      function () {
        return JestSDKHelper.getSdk().referrals.shareReferralLink(
          JestSDKHelper.parseJson(optionsJson),
        );
      },
    );
  },
        ...
        return JestSDKHelper.getSdk()
          ...
          .then(function (data) {
            ...
            return JSON.stringify({
              ...
              referralsSigned:
                data && data.referralsSigned ? data.referralsSigned : "",
            });
          });
      },
    );
  ...
  JS_redirectToGame: function (optionsJson) {
    ...
    if (options.redirectToFlagship) {
      sdk.internal.redirectToFlagshipGame({
        entryPayload: options.entryPayload
          ? JSON.parse(options.entryPayload)
          : undefined,
      });
      return;
    }
  ...
  JS_debugRegister: function () {
    ...
    window.parent.postMessage(
      { type: "debug-register", phoneNumber: phoneNumber },
      "*",
    );
  },
  ...
  JS_getFeatureFlag: function (taskPtr, key, successCallback, errorCallback) {
    JestSDKHelper.callStringTask(
      ...
      function () {
        return JestSDKHelper.getSdk()
          .internal.getFeatureFlag(UTF8ToString(key))
          .then(function (value) {
  ...
  JS_reserveLoginMessage: function (
    taskPtr,
    optionsJson,
    successCallback,
    errorCallback,
    ...
    JestSDKHelper.callStringTask(
      ...
      function () {
        return JestSDKHelper.getSdk()
          .internal.reserveLoginMessageAsync(
            JestSDKHelper.parseJson(optionsJson),
          )
          .then(function (result) {
            return JSON.stringify(result);
  ...
  JS_sendReservedLoginMessage: function (reservationJson) {
    JestSDKHelper.getSdk().internal.sendReservedLoginMessage(
      JestSDKHelper.parseJson(reservationJson),
    );
  },
  ...
  JS_markGameLoaded__deps: ["$JestSDKHelper"],
  JS_markGameLoaded: function () {
    JestSDKHelper.getSdk().markGameLoaded();
  },

  JS_beginPlatformRegistrationOverlay__deps: ["$JestSDKHelper"],
  JS_beginPlatformRegistrationOverlay: function (
    taskPtr,
    optionsJson,
    onClose,
    onError,
    ...
    try {
      ...
      var handle = JestSDKHelper.getSdk().showRegistrationOverlay({
        ...
        onClose: function () {
          ...
          notified = true;
          if (conversationId)
            delete JestSDKHelper.overlayHandles[conversationId];
          {
            {
              {
                makeDynCall("vi", "onClose");
              }
            }
          }
          taskPtr;
    ...
    } catch (err) {
      {
        {
          {
            makeDynCall("vii", "onError");
          }
        }
      }
      (taskPtr, JestSDKHelper.marshalString(JestSDKHelper.toErrorMessage(err)));
    }
  },
  ...
  JS_validateName: function (taskPtr, name, successCallback, errorCallback) {
    JestSDKHelper.callStringTask(
      ...
      function () {
        return JestSDKHelper.getSdk()
          .internal.validateName(UTF8ToString(name))
          .then(function (result) {
            return JSON.stringify(result);
          });
      },
